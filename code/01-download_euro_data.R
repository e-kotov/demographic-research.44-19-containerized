...
# educ <- get_eurostat('edat_lfse_04') # not available anymore
...
#   drop_na()
euro_education <- data.table::fread("data/euro_education.csv")
...
#   drop_na()
euro_sectors <- data.table::fread("data/euro_sectors.csv")
